...
export default function AdminInvestorListPage() {
    ...
    <PortalLayout role="ops">
      <div className="space-y-6">
        <div className="text-left">
          <h1 className="text-xl font-semibold">All Investors</h1>
          <p className="text-sm text-muted-foreground">View all investor profiles across IFAs</p>
        </div>
